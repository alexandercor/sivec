...
class MreporteConsolidadoMensualModel extends Model{

    public function mreporte_consolidado_mes_detalle_listav1($codControl): array {
        $sql = '
            SELECT 
    ...
    public function mreporte_consolidado_mes_detalle_lista($codControl): array {
        $sql = '
            SELECT 
                `tb_det_control`.`id_detalle_control` key_detalle_control,
                `tb_det_control`.`codigo_manzana` cod_manzan,
    ...
    public function mreporte_consolidado_mensual_viviendas($codDetalleControl): object {
        $sql = '
            SELECT 
    ...
    public function mreporte_consolidado_mensual_tipos_depositos($codDetalleControl): array {
        $sql = '
            SELECT 
                `tb_det_control`.`id_detalle_control` key_detalle_control,
    ...
    public function mreporte_consolidado_mensual_depositos_tipos($codDetalleControl): array {
        $sql = '
            SELECT 
