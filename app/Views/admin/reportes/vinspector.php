...
<!--  -->
<?= $this->section('page_title') ?> Reportes - Inspector | <?= SYS_TITLE; ?> 
<?= $this->endSection() ?>
...
<?= $this->section('contenido') ?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa-sliders-h"></i> Reportes - Inspector</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('home')?>">Inicio</a></li>
              <li class="breadcrumb-item active">Reportes - Inspector</li>
            </ol>
          </div>
        </div>
      </div>
